export const products = [
  {
    ...
    description:
      "Breathable and stylish cotton shirt for daily comfort. Perfect for casual outings and semi-formal wear.",
    price: 1899,
  ...
  },
  {
    ...
    description:
      "Elegant traditional silk saree with fine zari border. Perfect for weddings and festive occasions.",
    price: 5299,
  ...
  },
  {
    ...
    description:
      "Modern slim-fit joggers made for active and casual lifestyles. Flexible, durable, and stylish.",
    price: 1499,
    brand: "UrbanFlex",
    chart: [],
    colors: [
