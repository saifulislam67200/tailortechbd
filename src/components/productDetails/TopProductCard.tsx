...
//! i will remove ts disable, when i implement the api
...
const TopProductCard = ({ ...product }) => {
  return (
    <div className="flex h-[120px] w-full items-center gap-[20px] rounded-[5px] bg-white p-[12px] shadow-xs transition-all duration-400 ease-in-out hover:shadow-lg">
      ...
      <div>
        <h1 className="line-clamp-1 text-[13px] font-bold">
          Canon Pixma G3010 All In One Ink Tank Print
        </h1>
        <p className="text-14px font-semibold text-strong">TK: 2500</p>
