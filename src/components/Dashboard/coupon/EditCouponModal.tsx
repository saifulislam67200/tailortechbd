...
const EditCouponModal = ({ coupon }: Props) => {
  ...
  const handleUpdateCoupon = async (
    ...
    const res = await updateCoupon({ id: coupon._id!, payload });
              ...
              <Form className="space-y-6">
                <div className="space-y-6">
                  <div className="flex items-center gap-3 bg-primary/10 p-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-primary">Edit Coupon</h3>
                      <p className="text-sm text-primary">Update coupon details</p>
                    </div>
                  </div>
                              ...
                              onClick={() => {
                                if (newUser.trim()) {
                                  const user = users.find(
                                    (u: TUser) => u.phoneNumber === newUser.trim()
                                  );
                                  if (user) {
                                    push({
                                      id: user._id,
                  ...
                  <div className="flex w-full justify-end gap-4">
                    <button
                      ...
                      className="cursor-pointer border border-quaternary px-4 py-2 text-info hover:bg-gray-100"
                    >
                      Cancel
                    </button>
                    <button
