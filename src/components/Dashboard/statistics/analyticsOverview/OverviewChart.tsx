...
const timePeriodData: TimePeriodDataType = {
  today: [
    { time: "03:00", Sales: 15, Earnings: 10, Customers: 5 },
    { time: "03:30", Sales: 51, Earnings: 32, Customers: 18 },
    { time: "04:00", Sales: 30, Earnings: 20, Customers: 12 },
    { time: "05:00", Sales: 25, Earnings: 15, Customers: 8 },
  ],
  this_month: [
    { time: "Week 1", Sales: 120, Earnings: 80, Customers: 45 },
    { time: "Week 2", Sales: 200, Earnings: 130, Customers: 70 },
    { time: "Week 3", Sales: 180, Earnings: 120, Customers: 65 },
    { time: "Week 4", Sales: 150, Earnings: 100, Customers: 55 },
  ],
  this_year: [
    { time: "Jan", Sales: 450, Earnings: 300, Customers: 150 },
    { time: "Feb", Sales: 480, Earnings: 320, Customers: 160 },
    { time: "Mar", Sales: 520, Earnings: 350, Customers: 170 },
    { time: "Apr", Sales: 550, Earnings: 370, Customers: 180 },
  ],
  overall: [
    { time: "2020", Sales: 4000, Earnings: 2800, Customers: 1200 },
    { time: "2021", Sales: 4800, Earnings: 3200, Customers: 1500 },
    { time: "2022", Sales: 5200, Earnings: 3500, Customers: 1700 },
    { time: "2023", Sales: 6000, Earnings: 4000, Customers: 2000 },
  ],
};
  ...
  return (
    <div className="w-full">
      ...
      <div className="mb-[16px] flex flex-col gap-[16px] lg:flex-row">
        ...
        <EarningCard value={totals.Earnings} selectedFilter={selectedFilter.value} />
