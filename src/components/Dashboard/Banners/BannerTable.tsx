      ...
      {!isViewBannerPosition ? (
        <div className="flex flex-col gap-[10px]">
          <div className="flex flex-col gap-[15px] bg-white p-[16px]">
            ...
            {/* Action Buttons */}
            <div className="mb-[5px] flex flex-col justify-end gap-[12px] md:flex-row md:items-center">
              <AddBanner />
              <Button
                onClick={() => setIsViewBannerPosition(true)}
                className="flex items-center gap-[8px] rounded-[6px] border border-dashboard/20 bg-dashboard/10 px-[16px] py-[8px] text-[14px] font-medium text-dashboard transition-colors hover:bg-dashboard/20"
              >
        ...
        <ManageBannerPosition setIsViewBannerPosition={setIsViewBannerPosition} />
      )}
    </>
  );
};
